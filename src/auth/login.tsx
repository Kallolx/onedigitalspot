  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-4xl mx-auto flex flex-col lg:flex-row justify-center gap-6">
        {/* Image Section */}
        <div className="hidden lg:block w-full lg:w-1/2 h-96 lg:h-auto rounded-lg overflow-hidden hover:shadow-card transition-shadow duration-300">
          <img
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center">
          <Card className="bg-white border border-border hover:shadow-retro transition-shadow duration-300">
            <CardHeader className="items-center md:items-start pb-4">
              <h1 className="text-2xl font-semibold tracking-tighter text-primary font-pixel">Welcome Back!</h1>
            </CardHeader>
            <CardContent className="space-y-6">
              <form className="space-y-4" onSubmit={handleLogin}>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button className="text-sm text-primary hover:text-primary/80 font-medium font-sans transition-colors" type="button">
                    Forgot password?
                  </button>
                </div>
                {error && (
                ...
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-xs uppercase">
                    <span className="bg-white px-2 text-muted-foreground font-sans">Or continue with</span>
                  </div>
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <Button variant="outline" className="font-sans border-2 hover:border-primary/50 hover:bg-primary/5" type="button">
